...
let words: string[] = ['ggb', 'vgbg'] //задаем тип к массиву, массив будет принимать только строковоое значение 
let mixArr: [string, number] = ['dcnvflk', 123] // создание массива, с неколькими типами, сначала массив внутри типы по порядку потом при присваивание тоже пишется по порядку
